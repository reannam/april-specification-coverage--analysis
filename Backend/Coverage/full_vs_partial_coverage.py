...
require_groups(
    TERM_GROUPS,
    {"covered_statuses", "partially_covered_statuses", "not_covered_statuses"},
    source=COVERAGE_TERMS_FILE,
)

FULLY_COVERED_STATUSES = TERM_GROUPS["covered_statuses"]
...
def status_to_weight(status: str | None) -> float:
    """Apply the documented 1/0.5/0 policy; unknown values fail closed to zero."""
...
def calculate_full_vs_partial_coverage(
    ...
    Not covered or unrecognised = 0.0
    """
