...
INCONSISTENCY_REPORT_DIR = ANALYSIS_OUTPUT_DIR / "inconsistency_reports"
...
INCONSISTENCY_MODEL = os.getenv("INCONSISTENCY_MODEL", "gpt-5.6-sol")
INCONSISTENCY_AGENT_COUNT = max(1, int(os.getenv("INCONSISTENCY_AGENT_COUNT", "6")))
